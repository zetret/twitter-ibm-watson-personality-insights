...
public class MainActivity1 extends AppCompatActivity
    ...
    public static ResponseList<twitter4j.Status> list, list1, list2, list3;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        try {
            ...
            /*ca-app-pub-test~2545122152
            Banner ID: ca-app-pub-test/1012548636
            Interstitial ID: ca-app-pub-test/7375557254*/
    ...
    public boolean onNavigationItemSelected(MenuItem item) {
        ...
        if (id == R.id.home) {
            ...
            Intent howAct = new Intent(this, HowWorks.class);
    ...
    class RetrieveTweetTask extends AsyncTask<Void, Void, String> {
        ...
        protected void onPreExecute() {
            try {
                progressBar.setVisibility(View.VISIBLE);
                progressUpdateView.setTextColor(Color.parseColor("#009688"));
                progressUpdateView.setText("Reading the latest 800 Tweets if available.");
        ...
        protected String doInBackground(Void... urls) {
            ...
            try {
                ...
                cb.setOAuthConsumerKey("eerXr54H9EuftG8QN5BkztE1G");
                cb.setOAuthConsumerSecret("lEPhuhG7b0FqJrEbrQ7RUyjW5q3alpleflZzuGtB0MYMJTPA1f");
                cb.setOAuthAccessToken("42665824-Rz3LJmk6AaTguA9iifgbGP0YKKxCFCf9ytaJWXUEf");
                cb.setOAuthAccessTokenSecret("lFQLLmP2kZcfYniwWqPa43fYyGpB2HLJRoFtSntL8F66C");
        ...
        protected String doInBackground(Void... urls) {
            try {
                ...
                if (numOfWords < 200) {
                    ...
                    service.setUsernameAndPassword("YOUR_UN", "YOUR_PW");
        ...
        protected void onPostExecute(String response) {
            try {
                if (response == null) {
                    ...
                    Intent resAct = new Intent(MainActivity1.this, ResultsActivity.class);
